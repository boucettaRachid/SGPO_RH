...
<div class="mb-3 col-md-6">
    ...
    <div class="input-group mb-3">
        <select class="form-select" id="ID_employer" name="ID_employer" value="<?= $date['ID_employer'] ?>">
            <?php
            if ($employers) {
...
<div class="mb-3 col-md-6">
    ...
    <img width="100" class="img img-fluid" src="C:\wamp\www\SGPO_RH-Stagiaire\templets\Employer\images/<?= $date['Image'] ?>"><br>
  </div>
