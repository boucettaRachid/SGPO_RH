...
<form action="../../controle/Stagiaire/controle.php" method="post">
<style>
  .vh-100 {
...
<section class="vh-100" style="background-image: url('../../assets/img/pexels-marc-mueller-380769.jpg');">
  <div class="container py-5 h-100">
            ...
            <div class="col-md-6 col-lg-7 d-flex align-items-center">
              <div class="card-body p-4 p-lg-5 text-black">
                ...
                <form>
                  ...
                  <label class="form-label" for="form2Example17">Username<i class="bi bi-ear-fill" style="font-size: 2em; color: #007bff;"></i></label>
    ...
    <!-- Include Bootstrap JS and your script -->
