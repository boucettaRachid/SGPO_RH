            ...
            <?php foreach($rows as $row): ?>
                <tr>
                    ...
                    <th>
                        ...
                        <button type="button" class="btn btn-warning mr-2 align-middle"><a href="editEmploye.php?id=<?= $row[0]?>"><i class="fas fa-pen fa-xs" style="color: #ffffff;"></i></a></button>
                        ...
                        <div class="modal fade" id="id<?=$row[0]?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <a href="deletEmploye.php?id=<?= $row[0]?>" class="btn btn-danger">Eliminar</a>
