...
>
  ...
  <body>
  <form action="updateEmloye.php" method="post"enctype="multipart/form-data">
  <div class="content-wrapper">
    ...
    <div class="row">
      ...
      <div class="col-sm-10">
                <input  type="hidden" name="ID_employer" class="form-control" id="ID_employer" value="<?= $date['ID_employer'] ?>">
            </div>
  ...
  <input type="text" class="form-control" name="address" value="<?= $date['Address'] ?>" id="address">
      ...
      <div class="mb-3 col-md-6">
        ...
        <input type="text" name="profe" class="form-control" id="profe" value="<?= $date['Profe'] ?>">
      </div>
      ...
      <div class="mb-3 col-md-6">
        <label for="date_cration" class="form-label">date_creation</label>
        <input type="date" class="form-control" name="date_cration" value="<?= date('Y-m-d') ?>" id="date_cration">
      </div>
      <div class="mb-3 col-md-6">
  <label for="type_contrat" class="form-label">Type contrat</label>
  <input type="text" class="form-control" name="type_contrat" value="<?= $date['Type_contrat'] ?>" id="type_contrat">
</div>
<div class="mb-3 col-md-6">
  <label for="Salaire" class="form-label">Salaire</label>
  <input type="text" class="form-control" name="salaire"  value="<?= $date['Salaire'] ?>" id="salaire">
</div>
<div class="mb-3 col-md-6">
    <label for="fonction">Départements</label>
    <div class="input-group mb-3">
        <select class="form-select" id="ID_dep" name="ID_dep"value="<?= $date['ID_dep'] ?>">
            <?php
            if ($departments) {
...
<div class="mb-3 col-md-6">
    ...
    <img width="100" class="img img-fluid" src="../../templets/Admin/images/<?= $date['Image'] ?>"><br>
  </div>
